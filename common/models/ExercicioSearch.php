...
/**
 * ExercicioSearch represents the model behind the search form of `backend\models\Exercicio`.
 */
class ExercicioSearch extends Exercicio
{
    ...
    public function rules()
    {
        return [
            ...
            [['foto', 'nome_Exercicio', 'descrição'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'foto', $this->foto])
            ->andFilterWhere(['like', 'nome_Exercicio', $this->nome_Exercicio])
